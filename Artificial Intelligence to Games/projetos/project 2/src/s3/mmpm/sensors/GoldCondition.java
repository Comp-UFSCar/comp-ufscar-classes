...
import s3.mmpm.sensors.GoldSensor;
 ...
 */
public class GoldCondition extends Sensor {
	...
	public GoldCondition(GoldCondition rhs) {
	...
	public Object clone() {
		...
		GoldCondition e = new GoldCondition(this);
		return e;
	 ...
	 */
	static Sensor _backend = new RelationalCondition(new Invocation(new GoldSensor()), RelationalCondition.Operator.GREATER_EQUAL_THAN, new GetContextValue("minimum", ActionParameterType.INTEGER));
