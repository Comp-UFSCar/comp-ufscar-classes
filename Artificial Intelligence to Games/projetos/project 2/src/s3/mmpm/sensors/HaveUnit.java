 ...
 */
public class HaveUnit extends Sensor {
	 ...
	 */
	static Sensor _backend = new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)));
