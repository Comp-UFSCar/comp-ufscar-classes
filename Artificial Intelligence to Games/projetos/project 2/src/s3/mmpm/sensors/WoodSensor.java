 ...
 */
public class WoodSensor extends Sensor {
	...
	public WoodSensor(WoodSensor rhs) {
	...
	public Object clone() {
		...
		WoodSensor e = new WoodSensor(this);
		return e;
