 ...
 */
public class HaveWStable extends Sensor {
	...
	public HaveWStable(HaveWStable rhs) {
	...
	public Object clone() {
		...
		HaveWStable e = new HaveWStable(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WStable")))));
