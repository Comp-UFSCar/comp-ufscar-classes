 ...
 */
public class HaveWCatapult extends Sensor {

	public HaveWCatapult() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWCatapult(HaveWCatapult rhs) {
	...
	public Object clone() {
		...
		HaveWCatapult e = new HaveWCatapult(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WCatapult")))));
