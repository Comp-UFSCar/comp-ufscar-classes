 ...
 */
public class HaveWPeasant extends Sensor {
	...
	public HaveWPeasant(HaveWPeasant rhs) {
	...
	public Object clone() {
		...
		HaveWPeasant e = new HaveWPeasant(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WPeasant")))));
