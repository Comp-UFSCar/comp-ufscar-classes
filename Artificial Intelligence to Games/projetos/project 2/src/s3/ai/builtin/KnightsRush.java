...
/**
 * @author Santi: AI that builds the necessary to train knights, two peasants harvesting gold, and two harvesting wood, 
 *         then builds
 * 	       knights without stop and attacks! After a while, increases the number of peasants to 3 and 3, and builds a
 * 		   second barracks. It also looks for goldmines where there is still available gold
 * 		   Also, it sends knights in waves
 */
public class KnightsRush extends FootmenRush {
	
	public KnightsRush(String playerID) {
		super(playerID);
