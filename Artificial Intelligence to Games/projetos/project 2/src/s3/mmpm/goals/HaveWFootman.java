 ...
 */
public class HaveWFootman extends Sensor {
	...
	public HaveWFootman(HaveWFootman rhs) {
	...
	public Object clone() {
		...
		HaveWFootman e = new HaveWFootman(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WFootman")))));
