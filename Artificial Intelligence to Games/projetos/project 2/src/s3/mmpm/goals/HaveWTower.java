 ...
 */
public class HaveWTower extends Sensor {
	...
	public HaveWTower(HaveWTower rhs) {
	...
	public Object clone() {
		...
		HaveWTower e = new HaveWTower(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WTower")))));
