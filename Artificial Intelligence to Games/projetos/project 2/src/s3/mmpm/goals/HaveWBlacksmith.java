 ...
 */
public class HaveWBlacksmith extends Sensor {

	public HaveWBlacksmith() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWBlacksmith(HaveWBlacksmith rhs) {
	...
	public Object clone() {
		...
		HaveWBlacksmith e = new HaveWBlacksmith(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WBlacksmith")))));
