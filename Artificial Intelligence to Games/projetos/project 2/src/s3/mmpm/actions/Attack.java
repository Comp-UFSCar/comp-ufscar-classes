 ...
 */
public class Attack extends gatech.mmpm.Action {
	 ...
	 * the action.
	 */
	public Attack(String entityID, String playerID) {
	 ...
	 * pattern.
	 */
	static protected Sensor _validCondition = new EqualitySensor(new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new GetContextValue("target", ActionParameterType.ENTITY_ID)), new Pair<String, Sensor>("attribute", new ConstantString("owner"))), EqualitySensor.Operator.NOT_EQUAL_THAN, new GetContextValue("player", ActionParameterType.PLAYER));
