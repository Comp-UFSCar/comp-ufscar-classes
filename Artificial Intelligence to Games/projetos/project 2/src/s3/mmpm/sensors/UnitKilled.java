 ...
 */
public class UnitKilled extends Sensor {
	...
	public UnitKilled(UnitKilled rhs) {
	...
	public Object clone() {
		...
		UnitKilled e = new UnitKilled(this);
		return e;
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new Invocation(new EntityExists(), new Pair<String, Sensor>("entity", new GetContextValue("id", ActionParameterType.ENTITY_ID))), EqualitySensor.Operator.EQUAL_THAN, new False());
