...
import s3.mmpm.sensors.WoodSensor;
 ...
 */
public class WoodCondition extends Sensor {

	public WoodCondition() {
	} // Constructor

	//---------------------------------------------------------------

	public WoodCondition(WoodCondition rhs) {
	...
	public Object clone() {
		...
		WoodCondition e = new WoodCondition(this);
		return e;
	 ...
	 */
	static Sensor _backend = new RelationalCondition(new Invocation(new WoodSensor()), RelationalCondition.Operator.GREATER_EQUAL_THAN, new GetContextValue("minimum", ActionParameterType.INTEGER));
