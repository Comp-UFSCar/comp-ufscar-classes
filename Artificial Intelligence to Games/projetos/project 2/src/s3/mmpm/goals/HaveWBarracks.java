 ...
 */
public class HaveWBarracks extends Sensor {

	public HaveWBarracks() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWBarracks(HaveWBarracks rhs) {
	...
	public Object clone() {
		...
		HaveWBarracks e = new HaveWBarracks(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WBarracks")))));
