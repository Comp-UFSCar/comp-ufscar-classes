 ...
 */
public class HaveWTownhall extends Sensor {

	public HaveWTownhall() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWTownhall(HaveWTownhall rhs) {
	...
	public Object clone() {
		...
		HaveWTownhall e = new HaveWTownhall(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WTownhall")))));
