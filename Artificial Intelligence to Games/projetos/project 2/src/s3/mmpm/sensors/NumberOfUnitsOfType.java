 ...
 */
public class NumberOfUnitsOfType extends Sensor {

	public NumberOfUnitsOfType() {
	} // Constructor

	//---------------------------------------------------------------

	public NumberOfUnitsOfType(NumberOfUnitsOfType rhs) {
	...
	public Object clone() {
		...
		NumberOfUnitsOfType e = new NumberOfUnitsOfType(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Conditional(new RelationalCondition(new Invocation(new NumberOfEntities(), new Pair<String, Sensor>("type", new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new Pair<String, Sensor>("owner", new GetContextValue("owner", ActionParameterType.PLAYER))), RelationalCondition.Operator.GREATER_EQUAL_THAN, new GetContextValue("minimum", ActionParameterType.INTEGER)), new ConstantFloat(1.0), new ArithmeticSensor(new Invocation(new FLOAT(), new Pair<String, Sensor>("value", new GetContextValue("minimum", ActionParameterType.INTEGER))), ArithmeticSensor.Operator.DIV, new Invocation(new FLOAT(), new Pair<String, Sensor>("value", new Invocation(new NumberOfEntities(), new Pair<String, Sensor>("type", new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new Pair<String, Sensor>("owner", new GetContextValue("owner", ActionParameterType.PLAYER)))))));
	...
	static {
		...
		_listOfNeededParameters.add(new Pair<String,ActionParameterType>("minimum", ActionParameterType.INTEGER));
		

	} // static initializer

} // class NumberOfUnitsOfType
