...
/**
 * This condition gets a Boolean attribute from an entity.
 *          
 * @author David Llanso
 ...
 * 
 */
public class BoolAttribute extends Sensor 
{
	...
	public BoolAttribute(BoolAttribute ba) 
	{
		super(ba);
	...
	public Object evaluate(int cycle, GameState gs, String player, Context parameters) 
	{
		...
		if(e != null) {
                    Object o = e.featureValue(att);
                    if (o!=null && o instanceof Boolean) {
                        if (((Boolean)o).booleanValue()==true) return new Float(1.0f);
