 ...
 */
public class WTroop extends WUnit {

	public WTroop(String entityID, String owner) {
	...
	public void setSpeed(int rhs) {

		_speed = rhs;

	} // setSpeed

	public void setSpeed(String rhs) {

		_speed = Integer.parseInt(rhs);
	...
	static {
		...
		_listOfFeatures = new java.util.LinkedList<String>(WUnit.staticListOfFeatures());
		_listOfFeatures.add("speed");

		// Add valid actions to _listOfActions.
		_listOfActions = new java.util.LinkedList<Action>(WUnit.staticListOfActions());
