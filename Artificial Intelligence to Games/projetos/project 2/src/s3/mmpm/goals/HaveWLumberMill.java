 ...
 */
public class HaveWLumberMill extends Sensor {

	public HaveWLumberMill() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWLumberMill(HaveWLumberMill rhs) {
	...
	public Object clone() {
		...
		HaveWLumberMill e = new HaveWLumberMill(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WLumberMill")))));
