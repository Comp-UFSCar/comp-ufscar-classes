...
import gatech.mmpm.sensor.builtin.EntityAt;
...
public class Move extends gatech.mmpm.Action {
	 ...
	 * pattern.
	 */
	static protected Sensor _successCondition = new Invocation(new EntityAt(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", null), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", new GetContextValue("entityID", ActionParameterType.STRING)))), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE)));
	 ...
	 * pattern.
	 */
	static protected Sensor _validCondition = new Invocation(new Reachable(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", null), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", new GetContextValue("entityID", ActionParameterType.STRING)))), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE)));
