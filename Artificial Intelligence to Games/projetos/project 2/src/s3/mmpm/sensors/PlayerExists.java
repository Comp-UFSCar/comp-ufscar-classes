 ...
 */
public class PlayerExists extends Sensor {
	...
	public PlayerExists(PlayerExists rhs) {
	...
	public Object clone() {
		...
		PlayerExists e = new PlayerExists(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WPlayer")))), new Pair<String, Sensor>("owner", new GetContextValue("owner", ActionParameterType.PLAYER)));
