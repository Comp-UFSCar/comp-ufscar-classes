 ...
 */
public class GoldSensor extends Sensor {
	...
	public GoldSensor(GoldSensor rhs) {
	...
	public Object clone() {
		...
		GoldSensor e = new GoldSensor(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WPlayer")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", null))), new Pair<String, Sensor>("attribute", new ConstantString("gold")));
