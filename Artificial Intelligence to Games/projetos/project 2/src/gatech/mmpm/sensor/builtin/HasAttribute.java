...
/**
 * This condition tests whether an entity has an attribute.
 *          
 * @author David Llanso
 ...
 * 
 */
public class HasAttribute extends Sensor 
{
	...
	public HasAttribute(HasAttribute ha) 
	{
		super(ha);
