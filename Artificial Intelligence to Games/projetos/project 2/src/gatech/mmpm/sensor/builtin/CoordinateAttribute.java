...
/**
 * This condition gets a Coordinate (float[]) attribute from an entity.
 *          
 * @author David Llanso
 ...
 * 
 */
public class CoordinateAttribute extends Sensor 
{
	...
	public CoordinateAttribute(CoordinateAttribute ca) 
	{
		super(ca);
	...
	public Object clone() 
	{
		return new CoordinateAttribute();
