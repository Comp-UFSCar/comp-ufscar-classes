...
char *captura(char buffer[200],int pos)
{
    ...
    */
    ...
    while ((ponto_virgula < pos)&&(buffer[cont] != '\0'))
    {
        ...
        {
            // Enquanto nao achar o ponto e virgula que corresponde a auxiliar_pv e enquanto nao for o fim da string buffer
...
void insere_mov(char para_conta,char tipo[6],int *terminal,dados_usuario *usuario,float valor,char ref[100])
{
