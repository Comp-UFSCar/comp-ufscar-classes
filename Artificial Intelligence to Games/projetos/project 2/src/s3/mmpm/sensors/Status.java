...
public class Status extends Sensor {
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new GetContextValue("entity", ActionParameterType.ENTITY_ID)), new Pair<String, Sensor>("attribute", new ConstantString("status"))), EqualitySensor.Operator.EQUAL_THAN, new GetContextValue("status", ActionParameterType.INTEGER));
	...
	static {
		...
		_listOfNeededParameters.add(new Pair<String,ActionParameterType>("status", ActionParameterType.INTEGER));
