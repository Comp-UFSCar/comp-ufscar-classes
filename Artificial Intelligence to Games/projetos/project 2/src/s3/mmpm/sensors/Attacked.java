 ...
 */
public class Attacked extends Sensor {
	 ...
	 */
	static Sensor _backend = new RelationalCondition(new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new GetContextValue("id", ActionParameterType.ENTITY_ID)), new Pair<String, Sensor>("attribute", new ConstantString("cycle_last_attacked"))), RelationalCondition.Operator.GREATER_THAN, new ArithmeticSensor(new GetContextValue("cycle", ActionParameterType.INTEGER), ArithmeticSensor.Operator.MINUS, new ConstantInteger(50)));
	...
	static {
		...
		_listOfNeededParameters.add(new Pair<String,ActionParameterType>("id", ActionParameterType.ENTITY_ID));
