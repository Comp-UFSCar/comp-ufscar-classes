...
/*
	- Character/Enemy AI is implemented as a very simple rule-based system. There are 3 memory containers, containing WMEs
...
function HighLevelAI() {
	...
	this.perceive = function(character, map, time) {
		var perception = map.objectsInRadius(character.x, character.y, character.sightRadius);
