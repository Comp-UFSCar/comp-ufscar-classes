 ...
 */
public class HaveWFortress extends Sensor {

	public HaveWFortress() {
	} // Constructor

	//---------------------------------------------------------------

	public HaveWFortress(HaveWFortress rhs) {
	...
	public Object clone() {
		...
		HaveWFortress e = new HaveWFortress(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s3.mmpm.entities.WFortress")))));
