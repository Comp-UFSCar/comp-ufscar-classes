 ...
 */
public class NewUnitBy extends Sensor {
	...
	public NewUnitBy(NewUnitBy rhs) {
	...
	public Object clone() {
		...
		NewUnitBy e = new NewUnitBy(this);
		return e;
	...
	static {
		...
		_listOfNeededParameters.add(new Pair<String,ActionParameterType>("executionCycle", ActionParameterType.INTEGER));
